                            ...
                            <div class="table-title">
                                <div class="row">
                                    <div class="col-sm-2 mb-2">
                                        <p><a href="{{ route('admin.create_user') }}" class="text-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Insert New</a></p>
                                    </div>
                                </div>
                            </div>
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <button type="button" class="btn btn-outline-success mx-4">Insert</button>
